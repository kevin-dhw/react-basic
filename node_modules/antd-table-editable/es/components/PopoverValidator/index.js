...
function useDelayStatus(errors) {
  var _useState = useState(errors),
    ...
    delayErrors = _useState2[0],
    setDelayErrors = _useState2[1];
  useEffect(function () {
    if (errors.length) {
...
var PopoverValidator = function PopoverValidator(_ref) {
  var content = _ref.content,
    props = _objectWithoutProperties(_ref, _excluded);
  var _Form$Item$useStatus = Form.Item.useStatus(),
    errors = _Form$Item$useStatus.errors;
  var delayErrors = useDelayStatus(errors);
  return /*#__PURE__*/_jsx(Popover, _objectSpread(_objectSpread({}, props), {}, {
    content: content ? content(delayErrors) : /*#__PURE__*/_jsx(Typography.Text, {
      type: "danger",
      children: delayErrors[0]
    }),
